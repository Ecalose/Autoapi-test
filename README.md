...
## 问题&出错 ##
  ...
  * 以下问题均是老版（非P版AutoApiP的问题）
  
  * **P版出现的报错及解决方案已经写进程序，详细请运行后看action日志报告**

一，**Push Change 报错（2021-1-2号首次出现）**
...
* 更新 2-17-2021(00:00)
  * 更改获取Token的方式（本地/在线网页获取）
  * 更改重定向url为login.microsoftonline.com..... (微软提供的url)
  * 版本号v6.2.1
...
* 更新 2-9-2021 
  * AutoApi-v6.0发布（非必要更新，大同小异，升不升级无所谓）
      * 添加创建系api：自动发送天气邮件，上次文件，修改excel文件等 （以前都是查询系api:获取邮件，获取文件信息等）
      * 采用新版本系统：v0.0
      
      
* 更新 1-9-2021 
  * AutoApiP发布（非必要更新，大同小异，升不升级无所谓）
